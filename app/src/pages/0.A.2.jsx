      ...
      <div className="overlap-wrapper">
        <div className="overlap">
          ...
          <p className="um-espa-o-para-cresc">
            Um espaço para crescer, inovar e conviver. Agora acessível sempre
            que quiseres.
          </p>
          ...
          <div className="group">
            <div className="overlap-group">
              ...
              <div className="login">Esqueci-me da palavra passe</div>

              <div className="group-2">
                <div className="inserir-email-ou-n-m-wrapper">
                  <p className="inserir-email-ou-n-m">
                    Inserir email ou número de aluno
                  </p>
                </div>

                <p className="email-n-mero-de-al">Email / Número de Aluno</p>
              </div>

              <div className="overlap-group-wrapper">
                <div className="login-wrapper">
                  <div className="login-2">Recuperar</div>
                </div>
              </div>

              <div className="esqueci-me-da-palavr">Login</div>
            </div>
          </div>
        </div>
      </div>
